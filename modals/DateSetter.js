...
const DateSetter = ({
    ...
    setDay1,setDay2,setMon1,setMon2,setYear1,setYear2,setYear3,setYear4,
    day1,day2,mon1,mon2,year1,year2,year3,year4
})=>{
      const done =()=>{
        if(day1 === '' || day2 === '' || mon1 === '' || mon2 === '' || year1 === '' || year2 === '' || year3 === '' || year4 === ''){
            alert("Put the correct date format")
            return
        }
            setIsVisible(false)
      }
            ...
            <View style={{flex:1, justifyContent:'center', alignItems:'center', backgroundColor:'rgba(0, 0, 0, 0.5)', flexDirection:'column'}}>
                <View style={{ backgroundColor:'#ffffff', height:.24*height, width:.9*width,borderRadius:25, padding:15, alignItems:'center'}}>
                    <View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'center'}}>
                        <Text style={{fontSize:0.041*width, fontWeight:'bold', }}>Enter date</Text>
                    </View>
                    <View style={{flex:1,marginTop:20, justifyContent:'space-between', paddingBottom:5}}>
                            ...
                            <Text style={{fontSize:20}}>-</Text>
                            <TextInput style={{ borderColor:'#16abd5', borderWidth:1 ,width:30, height:30, borderRadius:5, alignItems:'center', justifyContent:'center', paddingHorizontal:7, fontSize:20, margin:3 }} keyboardType='number-pad' maxLength={1} value={year1} onChangeText={val=>setYear1(val)}/>
                            <TextInput style={{ borderColor:'#16abd5', borderWidth:1 ,width:30, height:30, borderRadius:5, alignItems:'center', justifyContent:'center', paddingHorizontal:7, fontSize:20, margin:3 }} keyboardType='number-pad' maxLength={1} value={year2} onChangeText={val=>setYear2(val)}/>
                            <TextInput style={{ borderColor:'#16abd5', borderWidth:1 ,width:30, height:30, borderRadius:5, alignItems:'center', justifyContent:'center', paddingHorizontal:7, fontSize:20, margin:3 }} keyboardType='number-pad' maxLength={1} value={year3} onChangeText={val=>setYear3(val)}/>
                            <TextInput style={{ borderColor:'#16abd5', borderWidth:1 ,width:30, height:30, borderRadius:5, alignItems:'center', justifyContent:'center', paddingHorizontal:7, fontSize:20, margin:3 }} keyboardType='number-pad' maxLength={1} value={year4} onChangeText={val=>setYear4(val)}/>
                            </View>
